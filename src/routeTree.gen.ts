...
const PartnerAirlinesRoute = PartnerAirlinesRouteImport.update({
  id: '/partner-airlines',
  path: '/partner-airlines',
  getParentRoute: () => rootRouteImport,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/partner-airlines': {
      id: '/partner-airlines'
      path: '/partner-airlines'
      fullPath: '/partner-airlines'
      preLoaderRoute: typeof PartnerAirlinesRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/pakistan-visa': {
      id: '/pakistan-visa'
