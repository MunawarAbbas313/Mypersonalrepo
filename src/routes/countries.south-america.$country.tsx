...
export const Route = createFileRoute("/countries/south-america/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best south america visa consultant islamabad, top south america visa agent pakistan, south america visa success rate pakistan, south america visa from pakistan 2026, AL ARBAB TRAVEL AND TOURS south america visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "AL ARBAB TRAVEL AND TOURS" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "South America"} Visa Consultant Islamabad — Pakistan's #1 | AL ARBAB TRAVEL AND TOURS` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://alarbabtravels.pk/countries/south-america/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://alarbabtravels.pk/countries/south-america/${loaderData?.slug || ""}` },
    ],
  }),
...
function SouthAmericaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://alarbabtravels.pk/countries/south-america/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
