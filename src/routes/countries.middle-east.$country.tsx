...
import { MIDDLE_EAST_COUNTRIES } from "@/data/regions/middle-east_countries";
...
export const Route = createFileRoute("/countries/middle-east/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best middle east visa consultant islamabad, top middle east visa agent pakistan, middle east visa success rate pakistan, middle east visa from pakistan 2026, AL ARBAB TRAVEL AND TOURS middle east visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "AL ARBAB TRAVEL AND TOURS" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Middle East"} Visa Consultant Islamabad — Pakistan's #1 | AL ARBAB TRAVEL AND TOURS` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://alarbabtravels.pk/countries/middle-east/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://alarbabtravels.pk/countries/middle-east/${loaderData?.slug || ""}` },
    ],
  }),
...
function MiddleEastCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://alarbabtravels.pk/countries/middle-east/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
