...
const TICKETING_FAQS = [
  { q: "Is AL ARBAB TRAVEL AND TOURS an IATA-authorized travel agency?", a: "Yes. AL ARBAB TRAVEL AND TOURS holds full IATA accreditation, allowing us to issue tickets directly on 300+ airlines worldwide with guaranteed fare accuracy and instant e-ticket confirmation." },
...
export const Route = createFileRoute("/air-ticketing")({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "AL ARBAB TRAVEL AND TOURS" },
      { property: "og:title", content: "Best Air Ticketing Agency in Islamabad — Cheap International Flights | AL ARBAB TRAVEL AND TOURS" },
      { property: "og:description", content: "Book the cheapest international flights from Islamabad with IATA-certified AL ARBAB TRAVEL AND TOURS. Instant e-tickets on 300+ airlines. 24/7 WhatsApp support." },
      { property: "og:url", content: "https://alarbabtravels.pk/air-ticketing" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "#1 Air Ticketing Agency Islamabad — AL ARBAB TRAVEL AND TOURS" },
    ...
    links: [
      { rel: "canonical", href: "https://alarbabtravels.pk/air-ticketing" },
    ],
  }),
    ...
    <>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="container-px relative mx-auto max-w-3xl text-center z-10">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <a
              href="https://wa.me/92315323811?text=Hi%2C%20I%20need%20a%20fare%20quote%20for%20a%20flight."
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <span className="relative z-10">Contact AL ARBAB TRAVEL AND TOURS Expert</span>
            </a>
            <a
              href="https://wa.me/92315323811?text=Hi%2C%20I%20need%20a%20fare%20quote%20for%20a%20flight."
              target="_blank"
      ...
      <section className="container-px mx-auto max-w-7xl py-20">
        <div className="group relative overflow-hidden rounded-[3rem] border border-white/10 shadow-2xl">
          <img
            src="/air_ticketing_hero_1777294022698.webp"
            alt="Modern Aviation"
            loading="lazy"
            decoding="async"
          ...
          <div className="lg:col-span-2 space-y-12">
            <div>
              <h2 className="text-3xl font-bold md:text-4xl mb-8">
                Why Choose AL ARBAB TRAVEL AND TOURS for Your Flight Bookings?
              </h2>
              <div className="prose prose-slate max-w-none text-muted-foreground leading-relaxed space-y-6 text-lg">
                <p>
                  ...
                  overwhelming with so many options in Blue Area. However, AL ARBAB TRAVEL AND TOURS stands out
      ...
      <section className="container-px mx-auto max-w-4xl py-24">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg">Everything you need to know about booking flights with AL ARBAB TRAVEL AND TOURS</p>
        </div>
          ...
          "@graph": [
            {
              ...
              "alternateName": "AL ARBAB TRAVEL AND TOURS Air Ticketing",
              "url": "https://alarbabtravels.pk/air-ticketing",
              ...
              "sameAs": ["https://www.facebook.com/profile.php?id=61572120569006", "https://www.instagram.com/alarbabtravels.pk/", "https://www.linkedin.com/company/os-consultants/"]
            },
            {
              "@type": "FAQPage",
            ...
            },
            {
              "@type": "BreadcrumbList",
              "itemListElement": [
                { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://alarbabtravels.pk" },
                { "@type": "ListItem", "position": 2, "name": "Air Ticketing", "item": "https://alarbabtravels.pk/air-ticketing" }
              ]
            }
          ]
        })
