  ...
  return (
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <section className="relative overflow-hidden bg-[#03060f] pt-28 pb-20 md:pt-36 md:pb-28">
        {/* Background layers */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(13,71,161,0.25),transparent_55%)]" />
        ...
        <div className="container-px relative mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/50 font-medium max-w-2xl leading-relaxed mt-6">
              AL ARBAB TRAVEL AND TOURS is an IATA-authorized travel partner with direct access to real-time fares from{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2.5 bg-[#F7941D] hover:bg-[#0D47A1] text-white font-black text-sm px-8 py-3.5 rounded-full shadow-[0_4px_20px_rgba(247,148,29,0.35)] hover:shadow-[0_8px_30px_rgba(13,71,161,0.4)] hover:-translate-y-0.5 transition-all group/cta"
              >
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`flex items-center gap-2 whitespace-nowrap px-4 py-2 rounded-full text-[11px] font-black uppercase tracking-wider transition-all duration-300 shrink-0 ${
                  activeCategory === cat
                    ? "bg-[#0D47A1] text-white shadow-[0_4px_12px_rgba(13,71,161,0.25)]"
                    : "bg-white border border-border/60 text-muted-foreground hover:border-[#0D47A1]/30 hover:text-[#0D47A1]"
                }`}
              >
      ...
      <section className="bg-white border-y border-border/40 py-20">
        <div className="container-px mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-3">Why Choose AL ARBAB TRAVEL AND TOURS</p>
      ...
      <section className="bg-[#03060f] py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(13,71,161,0.15),transparent_60%)]" />
        <div className="container-px mx-auto max-w-3xl text-center relative z-10">
          ...
          <a
            href={`https://wa.me/${COMPANY.whatsapp.replace(/\D/g, "")}?text=${encodeURIComponent("Hi AL ARBAB TRAVEL AND TOURS! I'd like to book a flight. Please help me find the best available fares from your partner airlines.")}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#F7941D] hover:bg-[#0D47A1] text-white font-black text-sm px-10 py-4 rounded-full shadow-[0_4px_30px_rgba(247,148,29,0.35)] hover:shadow-[0_8px_40px_rgba(13,71,161,0.4)] hover:-translate-y-1 transition-all duration-300 group/final"
          >
