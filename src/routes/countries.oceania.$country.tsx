...
export const Route = createFileRoute("/countries/oceania/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best oceania visa consultant islamabad, top oceania visa agent pakistan, oceania visa success rate pakistan, oceania visa from pakistan 2026, AL ARBAB TRAVEL AND TOURS oceania visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "AL ARBAB TRAVEL AND TOURS" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Oceania"} Visa Consultant Islamabad — Pakistan's #1 | AL ARBAB TRAVEL AND TOURS` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://alarbabtravels.pk/countries/oceania/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://alarbabtravels.pk/countries/oceania/${loaderData?.slug || ""}` },
    ],
  }),
...
function OceaniaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://alarbabtravels.pk/countries/oceania/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
