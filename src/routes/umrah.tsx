...
import umrahHero from "@/assets/umrah-hero.webp";

export const Route = createFileRoute("/umrah")({
  head: () => ({
    meta: [
      { title: "Best Umrah Packages from Pakistan 2026 — Pakistan's #1 Umrah Travel Agency | AL ARBAB TRAVEL AND TOURS" },
      {
        name: "description",
        content:
          "Pakistan's #1 Umrah travel agency. Book cheap Umrah packages from Islamabad 2026. Economy, 3-Star, 4-Star & 5-Star packages with visa, flights & hotels in Makkah & Madinah. Trusted by 5000+ families. AL ARBAB TRAVEL AND TOURS Blue Area.",
      },
      {
        name: "keywords",
        content:
      ...
      { property: "og:title", content: "Pakistan's #1 Umrah Packages 2026 — Economy to 5-Star Luxury | AL ARBAB TRAVEL AND TOURS" },
      {
        property: "og:description",
        content:
          "Trusted by 5000+ families. Economy to luxury Umrah packages from Islamabad with visa, flights & premium hotels near Haram.",
      },
      { property: "og:image", content: "/src/assets/umrah-hero.webp" },
      { property: "og:url", content: "https://alarbabtravels.pk/umrah" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_PK" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "#1 Umrah Packages Pakistan 2026 | AL ARBAB TRAVEL AND TOURS" },
      { name: "twitter:description", content: "Economy to 5-Star luxury. Visa, flights & Haram-facing hotels from Islamabad." },
    ],
    links: [
      { rel: "canonical", href: "https://alarbabtravels.pk/umrah" },
    ],
  }),
  component: UmrahPage,
});
...
function UmrahPage() {
  const umrahJsonLd = {
    ...
    "image": "https://alarbabtravels.pk/src/assets/umrah-hero.webp",
    "description": "Economy, 3-Star, 4-Star & 5-Star Umrah packages from Pakistan with visa, flights & hotels in Makkah & Madinah.",
    "brand": {
      "@type": "Brand",
    ...
    "offers": {
      ...
      "offers": UMRAH_PACKAGES.map((pkg) => {
        ...
        return {
          ...
          "price": priceNum,
          "priceCurrency": "PKR",
          "url": "https://alarbabtravels.pk/umrah",
  ...
  return (
    <>
      <script type="application/ld+json">{JSON.stringify(umrahJsonLd)}</script>
        ...
        <div className="container-px mx-auto max-w-7xl relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
              AL ARBAB TRAVEL AND TOURS is officially authorized by the Ministry of Hajj & Umrah. We cut out the middlemen to bring you direct contracts with top Saudi providers.
            </p>
          </div>
      ...
      <section className="container-px mx-auto max-w-5xl py-24">
        <div className="rounded-[3rem] border border-border/50 bg-card/20 backdrop-blur-md p-8 md:p-14 shadow-xl">
          ...
          <div className="mt-16 p-8 md:p-10 rounded-[2.5rem] bg-gradient-to-br from-secondary/40 to-background border border-border/50 relative overflow-hidden group shadow-inner">
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-10 text-center relative z-10">Why Book Your Umrah with AL ARBAB TRAVEL AND TOURS?</h3>
