...
import { GlobalSEO } from "@/components/site/GlobalSEO";
...
function RootComponent() {
  const jsonLd = {
    ...
    name: COMPANY.name,
    alternateName: ["AL ARBAB TRAVEL AND TOURS", "AL ARBAB TRAVEL AND TOURS", "AL ARBAB TRAVEL AND TOURS Islamabad"],
    description:
    ...
    image: "https://alarbabtravels.pk/src/assets/hero-travel.jpg",
    logo: "https://alarbabtravels.pk/logo.png",
    "@id": "https://alarbabtravels.pk",
