...
import { SCHENGEN_COUNTRIES } from "@/data/regions/schengen-countries";
...
export const Route = createFileRoute("/countries/schengen/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best schengen visa consultant islamabad, top europe visa agent pakistan, schengen visa success rate pakistan, schengen visa from pakistan 2026, AL ARBAB TRAVEL AND TOURS schengen visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "AL ARBAB TRAVEL AND TOURS" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Schengen"} Visa Consultant Islamabad — Pakistan's #1 | AL ARBAB TRAVEL AND TOURS` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://alarbabtravels.pk/countries/schengen/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://alarbabtravels.pk/countries/schengen/${loaderData?.slug || ""}` },
    ],
  }),
...
function SchengenCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://alarbabtravels.pk/countries/schengen/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
