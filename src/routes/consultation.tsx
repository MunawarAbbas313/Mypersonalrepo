...
export const Route = createFileRoute("/consultation")({
  head: () => ({
    meta: [
      { title: "Free Visa Consultation — Pakistan's #1 Visa Expert | AL ARBAB TRAVEL AND TOURS Islamabad" },
      {
        name: "description",
        content:
          "Book a free 15-minute visa consultation with Pakistan's best visa consultants. Get expert pathway analysis, document checklist & honest fee estimate. No obligation. AL ARBAB TRAVEL AND TOURS Blue Area, Islamabad.",
      },
      {
        name: "keywords",
        content: "free visa consultation islamabad, book visa appointment pakistan, visa expert consultation blue area, free immigration advice islamabad, AL ARBAB TRAVEL AND TOURS consultation, visa pathway assessment pakistan",
      },
      ...
      { property: "og:url", content: "https://alarbabtravels.pk/consultation" },
      { property: "og:type", content: "website" },
    ],
    links: [
      { rel: "canonical", href: "https://alarbabtravels.pk/consultation" },
    ],
  }),
